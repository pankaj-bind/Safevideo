...
class Video(models.Model):
    ...
    thumbnail = models.ImageField(upload_to='thumbnails/', null=True, blank=True, help_text="Auto-generated thumbnail from video")
    preview = models.FileField(upload_to='previews/', null=True, blank=True, help_text="Auto-generated short preview clip")
